...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      '/api': {
        target: 'https://pcitest.zhixue.com/', //http://172.31.7.83:8066/',//https://pcitest.zhixue.com/
        secure: false,
        changeOrigin: true,
        pathRewrite: {
          '^/api': '/'
    ...
    devtool: 'cheap-module-eval-source-map', //webpack提供的用来方便调试的配置，它有四种模式
  ...
  build: {
    ...
    // View the bundle analyzer class_report after build finishes:
    // `npm run build --class_report`
